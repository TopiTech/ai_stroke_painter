...
public:
    ...
    static constexpr int DEFAULT_GOAL_MASTERWORK_STEPS = 18;

    /**
     * Generate phase-specific guidance for Goal Mode (Phase 1: Blocking, Phase 2: Shading, Phase 3: Lineart, Phase 4: Finishing).
     */
    static QString generateGoalPhaseGuidance(int phase, const SemanticSpec &spec, const QSize &canvasSize, int totalSteps = DEFAULT_GOAL_MASTERWORK_STEPS);
