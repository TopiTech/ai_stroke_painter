...
)
{
    ...
    case DomainType::Character: {
        out += QStringLiteral(
            ...
            "- CLEAN FACE SHADING: Do NOT paste multiple fragmented polygon tiles over facial planes (prevents mottled bruising). Keep face skin surfaces smooth and luminous; limit facial shading to cohesive cast shadows under hair bangs/jawline, and soft warm blush.\n"
            ...
            "   - Eyes & Features: For anime style, STRONGLY PREFER 'anime_eye' (center, size, iris_color: %2, secondary_color, style: 'sparkle') to guarantee sparkling, perfectly proportioned anime irises with pupils and catchlights!\n"
            ...
            "   - Eyes & Expression: Draw sharp, delicate lash arches, double eyelids, and subtle lip lines with gpen or maru_pen (or use 'anime_eye').\n"
