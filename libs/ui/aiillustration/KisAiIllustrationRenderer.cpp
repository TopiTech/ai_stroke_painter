...
QByteArray KisAiIllustrationRenderer::formatBearerAuthHeader(const QString &apiKey)
{
...
QString KisAiIllustrationRenderer::redactCredentialText(const QString &text)
{
    if (text.isEmpty()) {
        return text;
    }
